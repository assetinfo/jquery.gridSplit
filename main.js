require(['gridsplit'], function(Gridsplit){
	    ...
	    // ends with a .forcePerWidth() to make sure the widths display as true percentages
	    ...
	    var grid1 = window.grid1 = $('#grid').gridSplit()
            ...
            .splitAt(1, 0).parent().forcePerWidth();
