...
!function(factory) {
    ...
    var gridSplit = function(el, options) {
        ...
        grid.init = function(el, options) {
            ...
            "" == this.settings.data ? (this.gridsStructure[0] = "null", this.addColumn(0), 
            this.gridsStructure[0][0] = "null", this.addCell(0, 0), 1 == this.settings.splitCellInColumn && this.addColumn(0)) : this.buildGrid(this.settings.data), 
            this;
            ...
            if ("undefined" != typeof y) {
                ...
                if (x + 1 == oThis.gridsStructure.length) oThis.gridsStructure[x + 1] = "null", 
